        ...
        <table className="border-collapse border border-gray-700 shadow-lg w-3/4 bg-white">
          ...
          <tbody>
            {[
              ...
              { id: 2, name: "TM-2", done: "21/06/2024", due: "21/06/2025" },
              { id: 3, name: "ENG-OIL", done: "09/01/2025", due: "09/01/2026" },
              { id: 4, name: "TXN-OIL", done: "14/09/2023", due: "14/09/2025" },
              { id: 5, name: "STRIP-INSP", done: "10/05/2022", due: "10/08/2026" },
              { id: 6, name: "STAB-OIL", done: "16/09/2022", due: "16/09/2027" },
            ].map((item, index) => {
            ...
            {/* Extra Data Rows */}
            {[
              { id: 7, label: "EFC", value: "13.0928" },
              { id: 8, label: "LAST DATE OF FIRE", value: "18/09/2024" },
