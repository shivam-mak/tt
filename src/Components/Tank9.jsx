    ...
    <>
      ...
      <div className="flex justify-center mt-5 overflow-x-auto">
        <table className="border-collapse border border-gray-700 shadow-lg w-3/4 bg-white">
          ...
          <tbody>
            {[
              { id: 1, name: "TM-1", done: "06/12/2024", due: "06/06/2025" },
              { id: 2, name: "TM-2", done: "06/12/2024", due: "06/12/2025" },
              { id: 3, name: "ENG-OIL", done: "06/05/2024", due: "06/05/2025" },
              { id: 4, name: "TXN-OIL", done: "21/05/2023", due: "21/05/2025" },
              { id: 5, name: "STRIP-INSP", done: "24/06/2022", due: "24/06/2026" },
              { id: 6, name: "STAB-OIL", done: "01/06/2022", due: "01/06/2027" },
            ].map((item, index) => {
            ...
            {/* Extra Data Rows */}
            {[
              { id: 7, label: "EFC", value: "223.6825" },
              { id: 8, label: "LAST DATE OF FIRE", value: "" },
              { id: 9, label: "BTY ISSUE AT", value: "04-05-2024" },
              { id: 10, label: "MAJOR DEFECT", value: "GUN CRADLE BKN." },
