    ...
    <>
      ...
      <div className="flex justify-center mt-5 overflow-x-auto">
        <table className="border-collapse border border-gray-700 shadow-lg w-3/4 bg-white">
          ...
          <tbody>
            {[
              { id: 1, name: "TM-1", done: "23/08/2024", due: "23/02/2025" },
              { id: 2, name: "TM-2", done: "23/08/2024", due: "23/08/2025" },
              { id: 3, name: "ENG-OIL", done: "23/08/2024", due: "23/08/2025" },
              { id: 4, name: "TXN-OIL", done: "23/05/2024", due: "23/08/2026" },
              { id: 5, name: "STRIP-INSP", done: "10/02/2023", due: "10/02/2027" },
              { id: 6, name: "STAB-OIL", done: "08/10/2020", due: "08/10/2025" },
            ].map((item, index) => {
            ...
            {/* Extra Data Rows */}
            {[
              { id: 7, label: "EFC", value: "87.5875" },
              { id: 8, label: "LAST DATE OF FIRE", value: "18/08/2020" },
              { id: 9, label: "BTY ISSUE AT", value: "27-02-2024" },
