    ...
    <>
      ...
      <div className="flex justify-center mt-5 overflow-x-auto">
        <table className="border-collapse border border-gray-700 shadow-lg w-3/4 bg-white">
          ...
          <tbody>
            {[
              { id: 1, name: "TM-1", done: "14/11/2024", due: "14/04/2025" },
              { id: 2, name: "TM-2", done: "25/04/2024", due: "25/04/2025" },
              { id: 3, name: "ENG-OIL", done: "06/09/2024", due: "06/09/2025" },
              { id: 4, name: "TXN-OIL", done: "26/09/2024", due: "26/09/2026" },
              { id: 5, name: "STRIP-INSP", done: "11/01/2021", due: "11/11/2025" },
            ...
            {/* Extra Data Rows */}
            {[
              { id: 7, label: "EFC", value: "94.6575" },
              { id: 8, label: "LAST DATE OF FIRE", value: "11/03/2024" },
