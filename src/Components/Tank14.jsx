    ...
    <>
      ...
      <div className="flex justify-center mt-5 overflow-x-auto">
        <table className="border-collapse border border-gray-700 shadow-lg w-3/4 bg-white">
          ...
          <tbody>
            {[
              { id: 1, name: "TM-1", done: "07/09/2024", due: "07/03/2025" },
              { id: 2, name: "TM-2", done: "07/09/2024", due: "07/09/2025" },
              { id: 3, name: "ENG-OIL", done: "16/02/2024", due: "16/02/2025" },
              { id: 4, name: "TXN-OIL", done: "24/04/2024", due: "24/04/2026" },
              { id: 5, name: "STRIP-INSP", done: "03/07/2024", due: "03/07/2028" },
            ...
            {/* Extra Data Rows */}
            {[
              { id: 7, label: "EFC", value: "65.4314" },
              { id: 8, label: "LAST DATE OF FIRE", value: "14/09/2024" },
              { id: 9, label: "BTY ISSUE AT", value: "18-01-2025" },
              { id: 10, label: "MAJOR DEFECT", value: "-NIL-" },
              { id: 11, label: "DEMAND", value: "ACU DEMAND" },
            ].map((item, index) => (
              <tr key={item.id} className={`text-lg border border-gray-500 ${index % 2 === 0 ? "bg-gray-100" : "bg-gray-200"}`}>
                <td className="px-6 py-3 border border-gray-700 text-center">{item.id}</td>
